...
class Window(QMainWindow):
    def __init__(self):
        ...
        uic.loadUi(r"uck.ui", self)

        self.setCentralWidget(Canvas())

        self.action_2.triggered.connect(self.centralWidget().setBrush)
        self.action_3.triggered.connect(self.centralWidget().setLine)
        self.action_4.triggered.connect(self.centralWidget().setCircle)
